package com.sky.hiwise.lessons.generator.engine.config;


import com.sky.hiwise.lessons.util.ToolUtil;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "advanced";
    private String projectPath = "/data/workspace/lg/test";//模板输出的项目目录
