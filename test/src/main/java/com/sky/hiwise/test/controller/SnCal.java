...
// paramsMap中先放入address，再放output，然后放ak，
// 放入顺序必须跟get请求中对应参数的出现顺序保持一致。

        //http://api.map.baidu.com/geoconv/v1/?coords=116.504785,39.95743&from=3&to=5&ak=
        Map paramsMap = new LinkedHashMap<String, String>();
        paramsMap.put("coords", "116.504785,39.95743");
        paramsMap.put("from", "3");
        paramsMap.put("to", "5");
        paramsMap.put("ak", "zoqMbQqd9BYukxnqSZ1mFHbxuGXG7xTd");

        // 调用下面的toQueryString方法，对LinkedHashMap内所有value作utf8编码，拼接返回结果address=%E7%99%BE%E5%BA%A6%E5%A4%A7%E5%8E%A6&output=json&ak=yourak
        String paramsStr = snCal.toQueryString(paramsMap);

        // 对paramsStr前面拼接上/geocoder/v2/?，后面直接拼接yoursk得到/geocoder/v2/?address=%E7%99%BE%E5%BA%A6%E5%A4%A7%E5%8E%A6&output=json&ak=yourakyoursk
        String wholeStr = new String("/geoconv/v1/?" + paramsStr + "PfCD8SjCT6U7Szd1hYu2kGNGUwoaZ4YH");
